...
"""
ajax/views.py:    stack_details = openstackUtils.get_stack_details(stack_name)
ajax/views.py:        stack_resources = openstackUtils.get_stack_resources(stack_name, stack_details["id"])
ajax/views.py:        if not openstackUtils.connect_to_openstack():
ajax/views.py:        tenant_id = openstackUtils.get_project_id(configuration.openstack_project)
ajax/views.py:        logger.debug(openstackUtils.create_stack(stack_name, heat_template))
ajax/views.py:    if openstackUtils.connect_to_openstack():
ajax/views.py:        logger.debug(openstackUtils.delete_stack(stack_name))
api/views.py:from common.lib import openstackUtils
api/views.py:    if openstackUtils.connect_to_openstack():
common/lib/consoleUtils.py:import openstackUtils
common/lib/consoleUtils.py:        if openstackUtils.connect_to_openstack():
common/lib/consoleUtils.py:            ws_url = openstackUtils.get_nova_serial_console(name)
common/lib/imageUtils.py:import openstackUtils
common/lib/imageUtils.py:        if openstackUtils.connect_to_openstack():
common/lib/imageUtils.py:                glance_detail = openstackUtils.get_glance_image_detail(image_id)
common/lib/imageUtils.py:                return openstackUtils.get_glance_image_detail_by_name(image_detail['name'])
common/lib/imageUtils.py:        if openstackUtils.connect_to_openstack():
common/lib/imageUtils.py:            images = openstackUtils.get_glance_image_list()
common/lib/imageUtils.py:        if openstackUtils.connect_to_openstack():
common/lib/imageUtils.py:            images = openstackUtils.get_glance_image_list()
common/lib/wistarUtils.py:import openstackUtils
common/lib/wistarUtils.py:        flavor_detail = openstackUtils.get_minimum_flavor_for_specs(configuration.openstack_project,
common/lib/wistarUtils.py:        if openstackUtils.connect_to_openstack():
common/lib/wistarUtils.py:            dhcp_leases = openstackUtils.get_consumed_management_ips()
images/views.py:from common.lib import openstackUtils
images/views.py:        openstackUtils.connect_to_openstack()
images/views.py:        glance_id = openstackUtils.get_image_id_for_name(image.name)
images/views.py:    if openstackUtils.connect_to_openstack():
images/views.py:        glance_id = openstackUtils.get_image_id_for_name(image.name)
images/views.py:            glance_json = openstackUtils.get_glance_image_detail(glance_id)
images/views.py:    if openstackUtils.connect_to_openstack():
images/views.py:        image_list = openstackUtils.list_glance_images()
images/views.py:    if openstackUtils.connect_to_openstack():
images/views.py:            openstackUtils.upload_image_to_glance(image.name, image.filePath.path)
images/views.py:    if openstackUtils.connect_to_openstack():
images/views.py:        image_details = openstackUtils.get_glance_image_detail(glance_id)
topologies/views.py:from common.lib import openstackUtils
topologies/views.py:        if openstackUtils.connect_to_openstack():
topologies/views.py:            logger.debug(openstackUtils.delete_stack(stack_name))
"""
